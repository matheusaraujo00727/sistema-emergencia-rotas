...
public class AtendimentoController {
    ...
    public ResponseEntity<AtendimentoResponseDTO> buscarPorId(
        ...
        Atendimento atendimento =
                atendimentoServiceImpl.buscarPorId(id);
    ...
    public ResponseEntity<AtendimentoResponseDTO> salvar(@RequestBody AtendimentoRequestDTO dto) {
        ...
        Atendimento salvo = atendimentoServiceImpl.salvar(
                        dto.ocorrenciaId(),
                        dto.equipeId(),
                        dto.recursoId(),
                        atendimento
    ...
    public ResponseEntity<AtendimentoResponseDTO> atualizar(
        ...
        Atendimento atualizado = atendimentoServiceImpl.atualizar(id, atendimento);

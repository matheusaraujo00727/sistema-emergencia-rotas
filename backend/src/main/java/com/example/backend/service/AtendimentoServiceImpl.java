...
public class AtendimentoServiceImpl implements IAtendimentoService {
    private final com.example.backend.util.AtendimentoLogger logger;
    ...
    private void iniciarFluxoAutomatico(Long atendimentoId) {
        ...
        new Thread(() -> {
            ...
            try {
                ...
                logger.log("STATUS ALTERADO | ID: " + atendimentoId +
                        " | EM_ANDAMENTO");
                ...
                logger.log("ATENDIMENTO FINALIZADO | ID: " + atendimentoId);
                ...
                logger.log("OCORRÊNCIA FINALIZADA | ID: " +
                        ocorrencia.getId());
                ...
                logger.log("RECURSO LIBERADO | ID: " +
                        recurso.getId());
                ...
                logger.log("EQUIPE LIBERADA | ID: " +
                        equipe.getId());

            } catch (Exception e) {
                logger.log("ERRO NO FLUXO AUTOMÁTICO | " + e.getMessage());
                e.printStackTrace();
            }
